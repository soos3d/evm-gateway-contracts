...
library MintAuthorizationLib {
    ...
    /// @notice Creates a typed memory view for a MintAuthorization or MintAuthorizationSet.
    ...
    /// @notice Validates the full structural integrity of an encoded MintAuthorizationSet memory view.
    ...
    /// @return ref The validated reference to the MintAuthorization or MintAuthorizationSet.
