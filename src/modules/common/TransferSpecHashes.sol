...
///
/// Manages a set of "transfer spec hashes" that have been used, in order to prevent replay. A "transfer spec hash" is
/// the `keccak256` hash of an encoded `TransferSpec` struct. This hash is also used as a cross-chain identifier.
